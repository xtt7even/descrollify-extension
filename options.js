...
function resetStats(resetButton) {
    if (isResetConfirmed(resetButton)) {
        ...
        chrome.storage.local.set({"lmwAverage": 32});
        chrome.storage.local.set({"wafAverage": 15});
        ...
        chrome.storage.local.set({ "savedTime": {hours: 0, minutes: 9, seconds: 0}})
        chrome.storage.local.set({ "watchSessionsDifference": 12})
        chrome.storage.local.set({ "sessionLmwWatchTimeHistory": []})
        chrome.storage.local.set({ "sessionWafWatchTimeHistory": []})
        chrome.storage.local.set({ "numberOfEscapes": 377})
